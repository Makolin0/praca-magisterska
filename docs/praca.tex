...
\begin{thebibliography}{99}
    ...
    \bibitem{nasu2018nnue} Yu Nasu, \textit{Efficiently Updatable Neural-Network-based Evaluation Function for Computer Shogi}, 23rd Game Programming Workshop (GPW), 2018.
    \bibitem{silver2018alphazero} David Silver, Thomas Hubert, Julian Schrittwieser, et al., \textit{A general reinforcement learning algorithm that masters chess, shogi, and Go through self-play}, Science 362 (6419), 1140-1144, 2018.
    \bibitem{knuth1975alphabeta} Donald E. Knuth, Ronald W. Moore, \textit{An analysis of alpha-beta pruning}, Artificial Intelligence 6(4), 293-326, 1975.
    \bibitem{mccloskey1989catastrophic} Michael McCloskey, Neal J. Cohen, \textit{Catastrophic Interference in Connectionist Networks: The Sequential Learning Problem}, The Psychology of Learning and Motivation, Vol. 24, 109-165, 1989.
